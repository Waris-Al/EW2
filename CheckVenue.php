                ...
                $x = 0;
                 ...
                 if(!$building)
                 {
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo $URL . $value['cname'] . '.pdf'; ?>" target="_blank" onclick="window.open('<?php echo $URL . $value['cname'] . '.pdf'; ?>','newwindow','width=800,height=600'); return false;"><?php echo $value['cname'];?></td>
